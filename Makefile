...
# -mwindows 关闭控制台窗口
# -lwinhttp http通信库
all: obj/vmFunc.o obj/cbeParser.o obj/mystd.o obj/fontEngine.o obj/vmMalloc.o obj/fileIoEngine.o obj/lcd.o obj/main.o build
...
obj/main.o: src/main.c
	$(CC) -g  -w -c -MMD -MP src/main.c -o obj/main.o
